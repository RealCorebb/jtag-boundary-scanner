...
* @brief  Win32 GUI
* @author Jean-Fran鏾is DEL NERO <Jean-Francois.DELNERO@viveris.fr>
*/
	...
	switch (message)
	{
		...
		case WM_COMMAND:
			...
			switch (wmEvent)
			{
				...
				case BN_CLICKED: //-> une check box a 閠?modifi閑
		...
		case WM_TIMER:
			if(timertick==0)
			{
				...
				// recuperation des etat d''entr閑 et mise ?jour des checkbox.
				i=0;
				while (i<c)
				{
					tmp_type = 0;
